...
f = open("conllner.txt", "w")
printer = f.write


for epoch, save_dir, checkpoint, model, seed in [
    (3, "lightning_logs/base-conllner-10epochs/checkpoints/0/", None, "t5-base", 0),
    (3, "lightning_logs/base-conllner-10epochs/checkpoints/1/", None, "t5-base", 1),
    (3, "lightning_logs/base-conllner-10epochs/checkpoints/2/", None, "t5-base", 2),
    (3, "lightning_logs/base-conllner-10epochs/checkpoints/3/", None, "t5-base", 3),
    (3, "lightning_logs/base-conllner-10epochs/checkpoints/4/", None, "t5-base", 4),
    (43, "lightning_logs/base-mpm-conllner-50epochs/checkpoints/0/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 0),
    (43, "lightning_logs/base-mpm-conllner-50epochs/checkpoints/1/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 1),
    (43, "lightning_logs/base-mpm-conllner-50epochs/checkpoints/2/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 2),
    (43, "lightning_logs/base-mpm-conllner-50epochs/checkpoints/3/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 3),
    (43, "lightning_logs/base-mpm-conllner-50epochs/checkpoints/4/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 4),
]:
    ...
    model = T5GenericFineTuner(args, "ner", "conll_2003")
