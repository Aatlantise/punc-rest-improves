...
for epoch, save_dir, checkpoint, model, seed in [
    (10, "lightning_logs/base-ore-10epochs/checkpoints/0/", None, "t5-base", 0),
    (10, "lightning_logs/base-ore-10epochs/checkpoints/1/", None, "t5-base", 1),
    (10, "lightning_logs/base-ore-10epochs/checkpoints/2/", None, "t5-base", 2),
    (10, "lightning_logs/base-ore-10epochs/checkpoints/3/", None, "t5-base", 3),
    (10, "lightning_logs/base-ore-10epochs/checkpoints/4/", None, "t5-base", 4),
    (50, "lightning_logs/base-mpm-ore-50epochs/checkpoints/0/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 0),
    (50, "lightning_logs/base-mpm-ore-50epochs/checkpoints/1/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 1),
    (50, "lightning_logs/base-mpm-ore-50epochs/checkpoints/2/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 2),
    (50, "lightning_logs/base-mpm-ore-50epochs/checkpoints/3/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 3),
    (50, "lightning_logs/base-mpm-ore-50epochs/checkpoints/4/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 4),
]:
    ...
    model = T5GenericFineTuner(args, "ore", "")
