...
class T5French(LightningModule):
    def __init__(
        self,
        adam_epsilon: float,
        eval_batch_size: int,
        ...
        model: str = 'guillaumephd/t5-french-base',
        num_workers: int = 4,
    ):
        super().__init__()
    ...
    def _verify_data_stored(self):
        if self.training_data is None:
            raise Exception('T5 french model has no stored TrainData data. Call .store_data() before using dataloaders!')
