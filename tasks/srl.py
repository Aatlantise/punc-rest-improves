...
for epoch, save_dir, checkpoint, model, seed in [
    # (1, "lightning_logs/base-srl-10epochs/checkpoints/0/", None, "t5-base", 0),
    # (1, "lightning_logs/base-srl-10epochs/checkpoints/1/", None, "t5-base", 1),
    # (1, "lightning_logs/base-srl-10epochs/checkpoints/2/", None, "t5-base", 2),
    # (1, "lightning_logs/base-srl-10epochs/checkpoints/3/", None, "t5-base", 3),
    # (1, "lightning_logs/base-srl-10epochs/checkpoints/4/", None, "t5-base", 4),
    (41, "lightning_logs/base-mpm-srl-50epochs/checkpoints/0/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 0),
    (41, "lightning_logs/base-mpm-srl-50epochs/checkpoints/1/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 1),
    (41, "lightning_logs/base-mpm-srl-50epochs/checkpoints/2/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 2),
    (41, "lightning_logs/base-mpm-srl-50epochs/checkpoints/3/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 3),
    (41, "lightning_logs/base-mpm-srl-50epochs/checkpoints/4/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 4),
]:
    ...
    model = T5GenericFineTuner(args, "srl", "")
