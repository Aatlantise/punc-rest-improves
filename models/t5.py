...
class PRT5(LightningModule):
    ...
    def forward(self, input_ids, attention_mask, labels = None) -> T5ForConditionalGeneration:
...
class MLMT5(LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.tokenizer: PreTrainedTokenizerBase = T5TokenizerFast.from_pretrained(model_name)
    
        # MLM collator: randomly mask tokens, use pad token as mask placeholder
