...
for epoch, save_dir, checkpoint, model, seed in [
    (10, "lightning_logs/base-ncner-10epochs/checkpoints/0/", None, "t5-base", 0),
    (10, "lightning_logs/base-ncner-10epochs/checkpoints/1/", None, "t5-base", 1),
    (10, "lightning_logs/base-ncner-10epochs/checkpoints/2/", None, "t5-base", 2),
    (10, "lightning_logs/base-ncner-10epochs/checkpoints/3/", None, "t5-base", 5),
    (10, "lightning_logs/base-ncner-10epochs/checkpoints/4/", None, "t5-base", 4),
    (50, "lightning_logs/base-mpm-ncner-50epochs/checkpoints/0/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 0),
    (50, "lightning_logs/base-mpm-ncner-50epochs/checkpoints/1/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 1),
    (50, "lightning_logs/base-mpm-ncner-50epochs/checkpoints/2/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 2),
    (50, "lightning_logs/base-mpm-ncner-50epochs/checkpoints/3/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 3),
    (50, "lightning_logs/base-mpm-ncner-50epochs/checkpoints/4/", "/data/t5-mpm-checkpoints/base-mpm-40epochs.ckpt",
     "t5-base", 4),
]:
    ...
    model = T5GenericFineTuner(args, "ner", "nc")
    ...
    # OoD eval
    model.dataset_file = "/data/t5-datasets/hyun_ner.pkl"
    printer(f"Task: {model.task}, dataset: {model.dataset_file}, seed: {seed}\n")
    test_dataset = get_generic_dataset(model.tokenizer, model.dataset_file, 'test', model.prompt, model.task)
    texts, outputs, targets = generate(ckpt, model, test_dataset, model.tokenizer, args.eval_batch_size, skip_special_tokens=True)
    object_generation_score(texts, outputs, targets, printer=printer)
